...
**Paste App** is a simple and lightweight application designed for quickly creating and storing text snippets, similar to note-taking apps. Users can easily paste, save, and organize short pieces of text or code for later reference. Ideal for managing temporary content like ideas, code snippets, or small notes, Paste App focuses on simplicity and ease of use, providing a minimalistic interface for quick access to saved text.
...
### Home Page
![Homepage](./src/assets/Paste%20App%20(%20Home%20).png)

### Paste Page
![Pastepage](./src/assets/Paste%20App%20(%20Paste%20).png)